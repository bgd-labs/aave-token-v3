...
abstract contract AaveUtils is BaseTest {
    ...
    address public constant AAVE_V2_IMPLEMENTATION =
        0xC13eac3B4F9EED480045113B7af00F7B5655Ece8;

    address public constant AAVE_TOKEN_PROXY_ADMIN =
    ...
    function updateAaveImplementation(address newImplementation) public {
        ...
        IBaseAdminUpgradeabilityProxy(address(AAVE_TOKEN)).upgradeTo(
            newImplementation
        );
    }
